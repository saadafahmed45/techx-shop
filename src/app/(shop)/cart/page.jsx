...
import {
  ...
  Truck, Plus, Minus, ArrowRight, Tag,
} from "lucide-react";
...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f5] mt-8 md:mt-2">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-8 md:py-12">
        ...
        {cart.length === 0 ? (
          <div className="bg-white rounded-3xl p-16 md:p-24 text-center max-w-lg mx-auto">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 bg-gray-900 text-white px-7 py-3.5 rounded-2xl font-bold text-sm hover:bg-gray-700 transition-colors"
            >
          ...
          <div className="grid lg:grid-cols-5 gap-6 md:gap-8 items-start">
            ...
            <div className="lg:col-span-3 space-y-4">
              ...
              {cart.map((item, i) => (
                <div
                  key={item._id}
                  className="bg-white rounded-3xl border border-gray-100 hover:border-gray-200 transition-colors group"
                >
              ...
              <div className="bg-white rounded-3xl border border-dashed border-gray-200 p-5">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-gray-400 transition-colors placeholder:text-gray-300"
                  />
            ...
            <div className="lg:col-span-2 sticky top-20 space-y-4">
              <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden">
                ...
                {/* Header */}
                <div className="bg-gray-900 px-6 py-5 flex items-center gap-2.5">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-500">Subtotal ({cart.length} {cart.length === 1 ? "item" : "items"})</span>
                    ...
                    {shipping > 0 && (
                      <p className="text-[11px] text-gray-500 bg-amber-50 rounded-xl px-3 py-2">
                  ...
                  <Link
                    href="/checkout"
                    className="flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-700 text-white py-4 rounded-2xl font-black text-sm tracking-wide transition-colors group"
                  >
                    Proceed to Checkout
                  ...
                  <Link
                    href="/"
                    className="flex items-center justify-center gap-2 border border-gray-200 text-gray-600 hover:border-gray-400 hover:text-gray-900 py-3.5 rounded-2xl text-sm font-semibold transition-colors"
                  >
                    <Truck size={14} />
                    Continue Shopping
                  </Link>
                  ...
                  <div className="flex items-center justify-center gap-2 pt-1">
                    {["bKash", "Nagad", "Card", "COD"].map((m) => (
                      <span
                        key={m}
                        className="text-[10px] font-bold text-gray-400 bg-gray-50 border border-gray-100 rounded-lg px-2 py-1"
                      >
                        {m}
                      </span>
                    ))}
...
// ── Stepper Dot ── (extracted to avoid repetition)
