...
import { FiSearch, FiTruck, FiCalendar, FiCreditCard, FiInfo, FiPackage, FiHelpCircle } from "react-icons/fi";
        ...
        <div className="w-full max-w-xl bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className={`flex items-center gap-4 px-5 py-4 ${meta.bg} border-b ${meta.border}`}>
            ...
            <div className="flex-1">
              ...
              {/* <p className="text-xs text-gray-400 mt-1">Order ID: #{shortId}</p> */}
            </div>
          </div>
          ...
          <div className="flex justify-center pb-5">
            <button type="button"
              className="flex items-center gap-2 text-sm text-gray-500 border border-gray-200 rounded-full px-4 py-1.5 hover:bg-gray-50 transition-colors">
