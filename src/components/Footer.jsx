...
const Footer = () => {
  return (
   <footer className="bg-slate-950">
    <div className=" px-6 md:px-32 py-12 md:py-24 mx-auto">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-2 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <a href="#" className="block mt-2 text-sm text-white  hover:underline">Technology</a>
                    ...
                    <div>
                        ...
                        <a href="#" className="block mt-2 text-sm text-white  hover:underline">Headphone cloud</a>
                        <a href="#" className="block mt-2 text-sm text-white  hover:underline">Computer & Laptops</a>
                        <a href="#" className="block mt-2 text-sm text-white  hover:underline">Gadget</a>
                    </div>
                    ...
                    <div>
                        ...
                        <span className="block mt-2 text-sm text-white  hover:underline">techxshop@email.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <p className="text-center text-white ">© TechX Shop 2026 - All rights reserved</p>
        </div>
    </div>
</footer>
  )
