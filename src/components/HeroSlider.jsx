...
const slides = [
  ...
  {
    image: "https://images.pexels.com/photos/4011762/pexels-photo-4011762.jpeg",
            ...
            <div className="relative   h-64 md:h-[80vh]  overflow-hidden w-full">
              <div className="w-full pt-[56.25%] sm:pt-[56.25%] lg:pt-[56.25%] relative bg-gray-100">
                <img
                  src={slide.image}
                  alt={slide.title}
                  className="absolute inset-0 w-full h-64 md:h-[80vh] object-cover transition-opacity duration-500"
                />
              </div>
              {/* Vertical Badge */}
